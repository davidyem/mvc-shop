...
class Product
{
    ...
    public static function getSearchItems($page=1,$search=false)
    {
        $search = false;
        if (isset($_POST['search'])) {
            ...
            while ($row = $result->fetch()) {
                $productsearch[$i]['id'] = $row['id'];
                $productsearch[$i]['name'] = $row['name'];
                $productsearch[$i]['price'] = $row['price'];
                $productsearch[$i]['is_new'] = $row['is_new'];
                $i++;
            }
